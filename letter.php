                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                          <div class="text-center article-title">
                            ...
                            <h1>
                                    ACCRA TECHNICAL UNIVERSITY <img src="<?php echo $rowaccess['photo']; ?>" width="157" height="175"></h1>
                          </div>
                            ...
                            <p align="justify">This is to certify that you have been cleared by the following departments : </p>
                              ...
                              <div align="justify">
                                  <ul>
                                    ...
                                    <li>Head of Student Affairs </li>
                                    <li>Head of Library </li>
                                    <li>Head of Student Affairs </li>
                                    <li>Head of Institutional Advancement/Alumni Relation </li>
                                  </ul>
                          </div>
                            <p align="justify">Your Details remains:</p>
                            <p align="justify"><strong>FULLNAME:</strong> <?php echo $rowaccess['fullname']; ?></p>
                            <p align="justify"><strong>INDEX NUMBER:</strong> <?php echo $rowaccess['matric_no']; ?></p>
                            ...
                            This certify that you have been fully cleared from Head of Finance, Head of Audit, Head of Department, Head of Student Affairs
                            </p>
