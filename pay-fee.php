        ...
        <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element"> <span>
                        <img src="<?php echo $rowaccess['photo'];  ?>" alt="image" width="60px" height="60px" class="img-circle" />
                         </span>
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p class="text-center style1"><strong>SCHOOL FEES :</strong>    <span class="badge badge-info">₵<?php echo number_format((float) $tot_fee ,2); ?></span></p>
                                <p class="text-center style1"><strong>TOTAL PAID :</strong>  <span class="badge badge-warning">₵<?php echo number_format((float) $tot_pay ,2); ?></span>   </p>
                                <p class="text-center style1"><strong>OUTSTANDING FEE :</strong>  <span class="badge badge-primary">₵<?php echo number_format((float) $outstanding_fee ,2); ?></span>   </p>
