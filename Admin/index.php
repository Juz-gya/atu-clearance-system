		   ...
		   <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">₵<?php echo number_format((float) $tot_pay ,2); ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
...
?>
                  ...
                  <div class="card-body p-0">
                    <ul class="users-list clearfix">
                      <li>
                        <img src="../<?php echo $row_new_students['photo'];  ?>" alt="students Image" width="30px" height="30px" class="rounded-circle border shadow">
