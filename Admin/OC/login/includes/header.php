...
<html lang="en">
    ...
    <head>
        ...
        <link rel="icon" type="image/png" sizes="32x32" href="img/logo/favicon/gctu-s.png">
        <link rel="icon" type="image/png" sizes="16x16" href="img/logo/favicon/gctu-s.png">
                    ...
                    <div class="navbar-default sidebar" role="navigation">
                        <div class="sidebar-nav navbar-collapse">
                            <ul class="nav" id="side-menu">
                                ...
                                <li><a href="../../../"><i class="fa fa-check fa-fw"></i>Student Clearance</a></li>
                                <li>
