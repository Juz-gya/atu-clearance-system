...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="../images/logo.png" alt=" Logo"  width="60px" height="60px" class="rounded-circle img-thumbnail" >
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../<?php echo $row['photo'];  ?>" alt="User Image" width="60px" height="60x" class="rounded-circle img-thumbnail">        </div>
        <div class="info">
            ...
            <tr>
              <td width="1043" height="214"><div class="card">
                ...
                <div class="card-body">
				 ...
				 <td><div align="center"><span class="controls"><img src="../<?php echo $row['photo'];?>"  width="50px" height="50px" class="rounded-circle border"/></span></div></td>
