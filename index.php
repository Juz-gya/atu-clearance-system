...
$head_lib = $rowaccess["head_lib"];
$head_department = $rowaccess["head_department"];
$head_ali = $rowaccess["head_ali"];
...
<title>ATU CLEARANCE SYSTEM</title>
            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                            <img src="<?php echo $rowaccess['photo'];  ?>" alt="image" width="60px" height="60px" class="image-circle" />
                             </span>
  
   
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"><span class="text-muted text-xs block">Index No:<?php echo $rowaccess['matric_no'];  ?> <b class="caret"></b></span> </span> </a>
    ...
    ?>
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h3 class="no-margins">₵ <?php echo number_format((float) $tot_fee ,2); ?> </h3>
                                <small> </small> 
						  </div>
                        </div>
                    </div>             
...
<div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h3 class="no-margins">₵ <?php echo number_format((float) $tot_pay ,2); ?></h3>
                                <small> </small> 
						  </div>
                        </div>
                    </div>    
...
<?php echo "Pending"; ?></div>
	  <?php } ?> </h3>
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h3 class="no-margins">₵ <?php echo number_format((float) $outstanding_fee ,2); ?>  </h3>
                                <small> </small> 
						  </div>
                        </div>
                    </div>             
        ...
        <div class="row">
          <div class="col-lg-12"> 
            ...
            <table  align="center">
              <tr>
                <td ><table border="0" align="center" class="table table-hover no-margins">
                  <thead>
                    <tr>
                    <th width="30%"><div align="center" class="style1">Head of Department</div></th>
                      <th width="30%"><div align="center"><span class="style1">Finance Officer </span></div></th>
                      <th width="30%"><div align="center" class="style1">Librarian</div></th>
					  <th width="30%"><div align="center"><span class="style1">Hostel Warden</span></div></th>
                      <th width="30%"><div align="center" class="style1">DRIPTT</div></th>
					   
                       <th width="30%"><div align="center" class="style1"></div></th>
                  ...
                  <tbody>
                   <tr>
                   <td>
					   	 <?php if (($rowaccess['head_department'])==(("0")))  { ?>
                     ...
                     <td>
                      ...
                      <td>
					   ...
					   <div align="center"><span class="label label-warning"></span> </div>
					   <?php } else {?>
					   <div align="center"><span class="label label-primary"></span> </div>
 						<?php } ?>
					    </td>
