...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      <img src="../images/logo.png" alt=" Logo"  width="60px" height="60px" class="rounded-circle img-thumbnail" style="opacity: .8">
                ...
                <div class="card-body">
                  <div class="form-group">
				   ...
				   <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtmatric_no" id="exampleInputEmail1" size="77" value="<?php if (isset($_POST['txtmatric_no']))?><?php echo $_POST['txtmatric_no']; ?>" placeholder="Enter Index No.">
                  </div>
