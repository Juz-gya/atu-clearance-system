<fieldset>
    ...
    <div class="form-group">
        ...
        <input type="text" name="certificate_number" min="1" max="9999999" value="<?php echo htmlspecialchars($edit ? $customer['certificate_number'] : '', ENT_QUOTES, 'UTF-8'); ?>" placeholder="Certificate Number" class="form-control" required="required" id="certificate_number">
    </div>
    <div class="form-group">
        <label for="training_name">Course*</label>
        <input type="text" name="training_name" value="<?php echo htmlspecialchars($edit ? $customer['training_name'] : '', ENT_QUOTES, 'UTF-8'); ?>" placeholder="Course " class="form-control" required="required" id="training_name">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="college_name">class *</label>
        <input type="text" name="marks" value="<?php echo htmlspecialchars($edit ? $customer['marks'] : '', ENT_QUOTES, 'UTF-8'); ?>" placeholder="class" class="form-control" required="required" id="marks">
    </div>
    <div class="form-group">
        <label>Gender *</label>
    ...
    <div class="form-group">
        ...
        <input name="phone" value="<?php echo htmlspecialchars($edit ? $customer['phone'] : '', ENT_QUOTES, 'UTF-8'); ?>" placeholder="eg. 0202490105" class="form-control"  type="text" id="phone">
    </div>
